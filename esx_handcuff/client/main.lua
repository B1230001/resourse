...
RegisterNetEvent('esx_handcuff:client:cuffPlayer')
AddEventHandler('esx_handcuff:client:cuffPlayer', function(target)
...
RegisterNetEvent('esx_handcuff:client:cuffingPlayer')
AddEventHandler('esx_handcuff:client:cuffingPlayer', function()
	local playerPed = GetPlayerPed(-1)
...
RegisterNetEvent('esx_handcuff:client:uncuffPlayer')
AddEventHandler('esx_handcuff:client:uncuffPlayer', function(target)
	cuffed = false
...
RegisterNetEvent('esx_handcuff:client:uncuffingPlayer')
AddEventHandler('esx_handcuff:client:uncuffingPlayer', function()
	local playerPed = GetPlayerPed(-1)
...
RegisterNetEvent('esx_handcuffs:ClosestPlayerCuff')
AddEventHandler('esx_handcuffs:ClosestPlayerCuff', function(type)
	local closestPlayer, distance = ESX.Game.GetClosestPlayer()

	if distance < 0.9 then
		TriggerServerEvent('esx_handcuff:cuff', GetPlayerServerId(closestPlayer), type)
	else
		ESX.ShowNotification('Er is niemand om te handboeien')
	end
end)

RegisterNetEvent('esx_handcuffs:ClosestPlayerUnCuff')
AddEventHandler('esx_handcuffs:ClosestPlayerUnCuff', function(type)
	local closestPlayer, distance = ESX.Game.GetClosestPlayer()

	if distance < 0.9 then
		TriggerServerEvent('esx_handcuff:uncuff', GetPlayerServerId(closestPlayer), type)
	else
		ESX.ShowNotification('Er is niemand om te handboeien')
	end
end)
...
AddEventHandler('esx_handcuffs:Drag', function()
	...
	if distance < 0.9 then
		TriggerServerEvent('esx_handcuff:drag', GetPlayerServerId(closestPlayer))
	else
...
RegisterNetEvent('esx_handcuff:dragPolice')
AddEventHandler('esx_handcuff:dragPolice', function(target)
...
RegisterNetEvent('esx_handcuff:dragCriminal')
AddEventHandler('esx_handcuff:dragCriminal', function(officer)
